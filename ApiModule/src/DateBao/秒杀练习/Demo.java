package DateBao.秒杀练习;

import java.text.ParseException;
import java.text.SimpleDateFormat;

/*秒杀开始时间是2020年11月11日 00:00:00,结束时间是2020年11月11日 00:10:00,用户小贾下单时间是2020
年11月11日 00:03:47,用户小皮下单时间是2020年11月11日 00:10:11,判断用户有没有成功参与秒杀活动
实现步骤
...
public class Demo {
    public static void main(String[] args) throws ParseException {
        ...
        long startTime = sdf1.parse(start).getTime();
        long endTime = sdf1.parse(end).getTime();
